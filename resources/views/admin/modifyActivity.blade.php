		...
		<div class="row">
			...
			<div
				...
				<div class="row">
					...
					<form class="form-horizontal" method="POST" action="/admin/activity/modify">
						{!! csrf_field() !!}
						<div class="form-group">
							<label for="inputTitle" class="col-sm-2 control-label">活动ID</label>

							<div class="col-sm-8 col-md-6 col-lg-8">
								<input name="id" type="text" class="form-control" readonly
									id="id" placeholder="{{ $activity->id }}"
									value="{{ $activity->id }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8 col-md-6 col-lg-8">
								<input name="title" type="text" class="form-control"
									id="inputTitle" placeholder="{{ $activity->title }}"
						...
						<div class="form-group">
							...
							<div class="col-sm-8 col-md-6 col-lg-8">
								<input name="introduction" type="text" class="form-control"
									id="inputIntroduction" placeholder="{{ $activity->introduction }}"
						...
						<div class="form-group">
							...
							<div class="col-sm-8 col-md-6 col-lg-8">
								...
								<input name="start" type="text" readonly class="form-control input-append date form_datetime"
									id="inputStart" placeholder="{{ $activity->start }}" value="{{ $activity->start }}">
								<script type="text/javascript">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 col-md-6 col-lg-8">
								...
								<input name="end" type="text" readonly class="form-control input-append date form_datetime"
									id="inputEnd" placeholder="{{ $activity->end }}" value="{{ $activity->end }}">
								<script type="text/javascript">
   							 $(".form_datetime").datetimepicker({
   	   							 format: 'yyyy-mm-dd hh:ii',
   	   						 	autoclose: true,
