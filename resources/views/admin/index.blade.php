								...
								<div class="panel panel-default">
									...
									<div class="panel-heading">
										...
										<button type="button"
											...
											data-toggle="modal" data-target="#myModal<?php echo $u->id ?>">
											<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
											删除
										</button>
										<a role="button" href="/admin/usermodify/<?php echo $u->id ?>"
									...
									<!-- Modal -->
									<div class="modal fade" id="myModal<?php echo $u->id ?>" tabindex="-1"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h5 class="modal-title" id="myModalLabel">确认删除用户？</h5>
												</div>
												<div class="modal-body">
													<button type="button" class="btn btn-default"
														data-dismiss="modal">取消</button>
													<a role="button" href="/admin/usermodify/delete/<?php echo $u->id ?>" 
