					...
					<form class="form" method="POST" action="/register">
						...
						<div class="form-group">
							<div class="input-group m-b-2">
								<span class="input-group-addon"><i class="icon-lock"></i></span>
								<input name="password_confirmation" id="inputPassword2"
						...
						<div class="form-group">
							<div class="input-group m-b-1">
								...
								<input name="nickname" id="inputNickname" type="text"
									   class="form-control" placeholder="昵称" value="{{ old('nickname') }}">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group m-b-1">
								...
								<input name="tel" id="inputTel" type="text"
									   class="form-control" placeholder="电话号码" value="{{ old('tel') }}">
							</div>
						</div>
