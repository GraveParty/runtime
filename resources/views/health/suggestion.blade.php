        ...
        <div class="row">
            ...
            <div class="sidebar col-xs-2 col-sm-3 col-md-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li role="presentation" class="active"><a href="{{ URL::to('/health/suggestion') }}">健康建议</a></li>
                </ul>
            </div>
            <!-- main content -->
            ...
            <div
				...
				@if($hasAsked==0)
				<a href="/health/suggestion/ask" 
				class="btn btn-large btn-success" role="button">&nbsp;申请建议&nbsp;
                <span class="glyphicon glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                </a>
				
				@else
				<a href="#" 
				class="btn btn-large btn-success disabled" role="button">&nbsp;已申请建议&nbsp;
                <span class="glyphicon glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                </a>
				@endif
								...
								<div class="panel panel-default">
									...
									<div class="panel-heading">
										...
										<button type="button"
											...
											data-toggle="modal" data-target="#myModal<?php echo $su->id ?>">
									...
									<!-- Modal -->
									<div class="modal fade" id="myModal<?php echo $su->id ?>" tabindex="-1"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<a role="button" href="/health/suggestions/delete/<?php echo $su->id ?>" 
